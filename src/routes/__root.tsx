...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "OHAYOU JAPAN" },
      { name: "twitter:description", content: "KL University × OHAYOU JAPAN" },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebSite",
              name: "OHAYOU JAPAN",
              alternateName: ["Ohayou Japan", "OHAYOU JAPAN KLU", "Ohayou Japan KLU"],
