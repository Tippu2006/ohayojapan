...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "OHAYŌ JAPAN" },
      { name: "twitter:description", content: "KL University × OHAYŌ JAPAN" },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebSite",
              name: "OHAYŌ JAPAN",
              alternateName: ["Ohayō Japan", "OHAYŌ JAPAN KLU", "Ohayō Japan KLU"],
